...
<input type="text" class="rounded border-gray-200 w-full mb-4" value="{{ old('title', @$post->title )}}" name="title">
...
<input type="text" class="rounded border-gray-200 w-full mb-4" value="{{ old('slug', @$post->slug )}}" name="slug">
